...
% xx=1:17;
% for i=1:17
%     yycr(i)=sum(Err(10*(i-1)+1:10*(i+3)))/40;
% end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%未改进的评估
for i=1:200
    Err2(i)=TrigPing2D(40,Node,100,100,i);
end
y2=polyfit(x,abs(Err2),3);
ycr2=y2(1)*x.^3+y2(2)*x.^2+y2(3)*x+y2(4);
scatter(x, abs(Err2),2);
hold on;
plot(x,ycr2);
legend("New","New","Raw","Raw");
